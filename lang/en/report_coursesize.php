...
$string['coursesize_desc'] = '<p>This report is updated using a scheduled task and only provides approximate values, if a file is used multiple times within a course or in multiple courses the report counts each instance even though Moodle only stores one physical version on disk.</p>';
